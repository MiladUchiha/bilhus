  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto px-4 hero-content">
          <h1 className="hero-title text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-light text-white mb-8 tracking-tight leading-[0.9]"
            ...
            Hyundai <span className="font-normal">Originalservice</span>
          </h1>
          <p className="hero-subtitle text-xl md:text-2xl lg:text-3xl text-white/95 mb-10 font-light leading-relaxed max-w-3xl mx-auto"
            ...
            Auktoriserad service med originaldelar och expertis för din trygghet
          </p>
      ...
      <div ref={contentRef} className="service-content">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div className="stat-item text-center group">
                <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-105">
                  ...
                  <div className="text-4xl md:text-5xl font-light text-gray-900 mb-2">24h</div>
                  <div className="text-sm text-gray-600 font-light">Garanti på arbete</div>
                </div>
              </div>
              <div className="stat-item text-center group">
                <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-105">
                  ...
                  <div className="text-4xl md:text-5xl font-light text-gray-900 mb-2">12år</div>
                  <div className="text-sm text-gray-600 font-light">Rostgaranti</div>
                </div>
              </div>
              <div className="stat-item text-center group">
                <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-105">
                  ...
                  <div className="text-4xl md:text-5xl font-light text-gray-900 mb-2">5år</div>
                  <div className="text-sm text-gray-600 font-light">Gratis MapCare</div>
                </div>
              </div>
              <div className="stat-item text-center group">
                <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-105">
                  ...
                  <div className="text-sm text-gray-600 font-light">Originaldelar</div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="service-card group bg-white rounded-3xl p-10 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-gray-200 hover:-translate-y-2">
                ...
                <ul className="space-y-4 text-gray-600">
                  ...
                  <li className="flex items-start group-hover:text-gray-700 transition-colors duration-300">
                    ...
                    <span className="font-light text-base">Oljefilter Hyundai original</span>
                  </li>
                  <li className="flex items-start group-hover:text-gray-700 transition-colors duration-300">
                    <svg className="w-5 h-5 text-gray-400 mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
        ...
        {/* Hyundai-specific Services */}
        <section className="special-services-section py-24 bg-gradient-to-br from-gray-50 via-gray-100 to-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20">
              <div className="inline-flex items-center bg-gray-900 text-white rounded-full px-6 py-2 mb-6">
                <span className="text-sm font-medium tracking-wide uppercase">Exklusivt</span>
              </div>
              <h2 className="section-header text-4xl md:text-5xl lg:text-6xl font-light text-gray-900 mb-6 tracking-tight">
                Hyundai-specifika Tjänster
              </h2>
              <p className="text-xl md:text-2xl text-gray-600 font-light max-w-3xl mx-auto leading-relaxed">
                Unika tjänster som endast auktoriserade Hyundai-verkstäder kan erbjuda
              </p>
            </div>
                ...
                <div className="space-y-8">
                  ...
                  <div className="service-card">
                    ...
                    <ul className="space-y-2 text-gray-600 ml-14">
                      <li className="flex items-start">
                        <span className="text-gray-400 mr-3">•</span>
                        <span className="font-light">Kontroll av eventuella fabriksuppdateringar</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-gray-400 mr-3">•</span>
                        <span className="font-light">Mjukvaruuppdateringar</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-gray-400 mr-3">•</span>
                        <span className="font-light">MapCare - navigationssystem (5 år gratis)</span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="service-card">
                    ...
                    <ul className="space-y-2 text-gray-600 ml-14">
                      <li className="flex items-start">
                        <span className="text-gray-400 mr-3">•</span>
                        <span className="font-light">Rostskyddsinspektion (12 års rostgaranti)</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-gray-400 mr-3">•</span>
                        <span className="font-light">Karossöversyn</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-gray-400 mr-3">•</span>
                        <span className="font-light">Hyundai Vägassistans förnyas (1 år, hela Europa)</span>
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <section className="older-cars-section py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20">
              <div className="inline-flex items-center bg-gray-100 rounded-full px-6 py-2 mb-6">
                <span className="text-sm font-medium text-gray-700 tracking-wide uppercase">Specialpaket</span>
              </div>
              <h2 className="section-header text-4xl md:text-5xl lg:text-6xl font-light text-gray-900 mb-6 tracking-tight">
                Service för Äldre Bilar
              </h2>
              <p className="text-xl md:text-2xl text-gray-600 font-light max-w-3xl mx-auto leading-relaxed">
                Specialanpassade servicepaket för Hyundai-bilar över 5 år
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="price-card group bg-gradient-to-br from-gray-50 to-white rounded-3xl p-10 shadow-xl hover:shadow-2xl border border-gray-200 hover:border-gray-300 transition-all duration-500 hover:-translate-y-1">
                <div className="flex items-center mb-8">
                  ...
                  <h3 className="text-3xl font-semibold text-gray-900 group-hover:text-gray-800 transition-colors duration-300">Hyundai Service 5+</h3>
                </div>
                
                <div className="mb-8">
                  <div className="text-5xl font-light text-gray-900 mb-3">1.795 kr</div>
                  <div className="text-lg text-gray-600 font-light">Fast pris för bilar äldre än 5 år</div>
                </div>
                ...
                <ul className="space-y-3 text-gray-600 mb-6">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="font-light">1 års Hyundai Assistans ingår</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="service-card bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 shadow-lg text-white">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl font-medium text-white">Originalservice 6+</h3>
                </div>
                
                <div className="mb-6">
                  <div className="text-lg text-white/90 font-light">Anpassat pris</div>
                  <div className="text-sm text-white/70 font-light">Enligt bilens ålder och servicebehov</div>
                </div>
                ...
                <ul className="space-y-3 text-white/90 mb-6">
                  <li className="flex items-start">
                    ...
                    <span className="font-light">Anpassad efter bilens ålder</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-white/70 mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="font-light">Individuellt servicebehov</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-white/70 mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="font-light">Ett års assistans ingår</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="service-card bg-white rounded-xl p-6 shadow-sm">
                    ...
                    <p className="text-gray-600 font-light">Varje år eller var 3000:e mil</p>
                  </div>
                  
                  <div className="service-card bg-white rounded-xl p-6 shadow-sm">
                    <h3 className="text-xl font-medium text-gray-900 mb-3">Elbilar</h3>
                    <p className="text-gray-600 font-light">15 000 eller 30 000 km beroende på modell</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700 font-light">24-timmars garanti på utfört arbete</span>
                  </div>
                  <div className="flex items-center">
                    <svg className="w-6 h-6 text-gray-400 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-gray-700 font-light">Beskrivning av utfört arbete</span>
                  </div>
                  <div className="flex items-center">
                    <svg className="w-6 h-6 text-gray-400 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700 font-light">Kostnadsfri besiktningskontroll (vid service)</span>
                  </div>
                </div>
              </div>
        ...
        <section className="py-32 bg-gradient-to-br from-gray-900 via-gray-800 to-black relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <p className="text-2xl md:text-3xl text-white/90 mb-12 font-light leading-relaxed max-w-3xl mx-auto"
              ...
              Professionell service med originaldelar och experttekniker
            </p>
